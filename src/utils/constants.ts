...
export const CONTACT_INFO = {
  ...
  email: 'bartendinglareserva@gmail.com',//Por modificar
...
export const PACKAGES = [
  ...
  },
  {
    ...
    cocktails: 5,
    features: [
      '2 a 6 bartenders profesionales',
      'Barra premium equipada',
      '5 cócteles de elegir',
      'Cristalería y hielo',
      'Decoración de barra',
      'Garnish artístico',
  ...
  },
  {
    ...
    features: [
      ...
      'Insumos e ingredientes premium',
    ],
    popular: false,
    serviceType: 'bartending-eventos',
  },
...
export const ADD_ONS = [
  ...
  {
    id: 'flabour-blaster',
    name: 'Flabour Blaster',
    description: 'Experiencia de coctelería molecular en tu evento',
    price: 300,
    unit: 'evento',
  },
  {
  ...
  {
    id: 'sellador-de-pieles',
    name: 'Sellador de Pieles',
    description: 'Dale un toque especial a tus cócteles con nuestro sellador de pieles',
    price: 220,
    unit: 'hora',
  },
  {
  ...
  },
  {
    ...
    description: 'Servilletas, posavasos y menú con logo de empresa',
    price: 600,
    unit: 'evento',
  },
] as const;
