// src/components/admin/correo/MessageDetailModal.tsx
import { Fragment, useState } from 'react';
import { Dialog, Transition } from '@headlessui/react';
import { X, Send, Mail, User, Calendar, Loader2 } from 'lucide-react';
...
export function MessageDetailModal({ isOpen, onClose, message, onReplySuccess }: MessageDetailModalProps) {
  ...
  const handleSendReply = async () => {
    ...
    try {
      ...
      setReplyText(''); // Limpiar campo
      onReplySuccess(); // Recargar tabla
