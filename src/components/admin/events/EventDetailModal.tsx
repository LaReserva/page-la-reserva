...
export function EventDetailModal({ event, isOpen, onClose, onUpdate }: EventDetailModalProps) {
  ...
  // ✅ LÓGICA DE ESTADO VISUAL CORREGIDA (Igual al calendario)
  ...
  const StatusBadge = () => {
    ...
    // Usamos displayStatus aquí para que el badge refleje el estado visual calculado
      ...
      <div className="relative w-full max-w-6xl bg-white rounded-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden">
        ...
        {showConfirmModal && (
          <div className="absolute inset-0 z-50 bg-white/95 backdrop-blur flex flex-col items-center justify-center text-center p-8 animate-in fade-in">
            ...
            <h3 className="text-2xl font-bold text-secondary-900 mb-2">Datos Completos</h3>
            <p className="text-secondary-500 max-w-md mb-8">¿Deseas marcar este evento como <strong>CONFIRMADO</strong>?</p>
        ...
        {showCancelModal && (
          <div className="absolute inset-0 z-50 bg-white/95 backdrop-blur flex flex-col items-center justify-center text-center p-8 animate-in fade-in">
            ...
            <p className="text-secondary-500 max-w-md mb-8">Esta acción es irreversible.</p>
            <div className="flex gap-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="date" value={formData.event_date || ''} onChange={(e) => handleInputChange('event_date', e.target.value)} disabled={!canEdit} className={cn("w-full text-sm font-medium border rounded-lg", dateError ? "border-red-500 bg-red-50" : "border-secondary-200")} />
